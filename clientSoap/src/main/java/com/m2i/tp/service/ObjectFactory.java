 ...
 * generated in the com.m2i.tp.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _EuroToFranc_QNAME = new QName("http://service.tp.m2i.com/", "euroToFranc");
    private final static QName _FrancToEuroResponse_QNAME = new QName("http://service.tp.m2i.com/", "francToEuroResponse");
    private final static QName _GetAuteur_QNAME = new QName("http://service.tp.m2i.com/", "getAuteur");
    private final static QName _EuroToFrancResponse_QNAME = new QName("http://service.tp.m2i.com/", "euroToFrancResponse");
    private final static QName _FrancToEuro_QNAME = new QName("http://service.tp.m2i.com/", "francToEuro");
    private final static QName _GetAuteurResponse_QNAME = new QName("http://service.tp.m2i.com/", "getAuteurResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.m2i.tp.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp.m2i.com/", name = "euroToFranc")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp.m2i.com/", name = "francToEuroResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp.m2i.com/", name = "getAuteur")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp.m2i.com/", name = "euroToFrancResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp.m2i.com/", name = "francToEuro")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.tp.m2i.com/", name = "getAuteurResponse")
